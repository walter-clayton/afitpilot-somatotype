...
import EnEcMan from "../../../image/Typespage_avatars/EnEc_man.svg";
import EnEcWoman from "../../../image/Typespage_avatars/EnEc_woman.svg";

export default function Types() {
  const EnEcImages: ITypeCarouselImage[] = [
    {
      image: EnEcMan,
      imageAltText: "EnEcMan",
    },
    {
      image: EnEcWoman,
      imageAltText: "EnEcWoman",
    },
  ];
  ...
  return (
    <Box>
          ...
          >
            <Grid item width={"100%"}>
              ...
              <Typography variant="h6" gutterBottom>
                What is a Endomorphic ectomorph?
              </Typography>
      ...
      <TypeExample carouselImages={EnEcImages} />
      <CounterShare />
      {/* <CommentPage /> */}
    </Box>
  );
