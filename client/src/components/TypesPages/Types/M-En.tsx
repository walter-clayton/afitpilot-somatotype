...
import M_EnMan from "../../../image/Typespage_avatars/M-En_man.svg";
import M_EnWoman from "../../../image/Typespage_avatars/M-En_woman.svg";

export default function Types() {
  const M_EnImages: ITypeCarouselImage[] = [
    {
      image: M_EnMan,
      imageAltText: "M_EnMan",
    },
    {
      image: M_EnWoman,
      imageAltText: "M_EnWoman",
    },
  ];
  ...
  return (
    <Box>
      ...
      <TypeExample carouselImages={M_EnImages} />
      <CounterShare />
      {/* <CommentPage /> */}
    </Box>
  );
