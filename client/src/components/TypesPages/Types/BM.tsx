...
import BMMan from "../../../image/Typespage_avatars/BM_man.svg";
import BMWoman from "../../../image/Typespage_avatars/BM_woman.svg";

export default function Types() {
  const BMImages: ITypeCarouselImage[] = [
    {
      image: BMMan,
      imageAltText: "BMMan",
    },
  ...
  return (
    <Box>
      ...
      <TypeExample carouselImages={BMImages} />
      <CounterShare />
      {/* <CommentPage /> */}
    </Box>
  );
