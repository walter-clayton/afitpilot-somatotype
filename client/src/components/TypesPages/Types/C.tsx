...
import CMan from "../../../image/Typespage_avatars/C_man.svg";
import CWoman from "../../../image/Typespage_avatars/C_woman.svg";

export default function Types() {
  const CImages: ITypeCarouselImage[] = [
    {
      image: CMan,
      imageAltText: "CMan",
    },
  ...
  return (
    <Box>
      ...
      <TypeExample carouselImages={CImages} />
      <CounterShare />
      {/* <CommentPage /> */}
    </Box>
  );
