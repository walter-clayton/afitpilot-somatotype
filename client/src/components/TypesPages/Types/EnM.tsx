...
import EnMMan from "../../../image/Typespage_avatars/EnM_man.svg";
import EnMWoman from "../../../image/Typespage_avatars/EnM_woman.svg";

export default function Types() {
  const EnMImages: ITypeCarouselImage[] = [
    {
      image: EnMMan,
      imageAltText: "EnMMan",
    },
  ...
  return (
    <Box>
          ...
          >
            <Grid item width={"100%"}>
              ...
              <Typography variant="h6" gutterBottom>
                What is a Endomorphic mesomorph?
              </Typography>
      ...
      <TypeExample carouselImages={EnMImages} />
      <CounterShare />
      {/* <CommentPage /> */}
    </Box>
  );
