...
import MEcMan from "../../../image/Typespage_avatars/MEc_man.svg";
import MEcWoman from "../../../image/Typespage_avatars/MEc_woman.svg";

export default function Types() {
  const MEcImages: ITypeCarouselImage[] = [
    {
      image: MEcMan,
      imageAltText: "MEcMan",
    },
  ...
  return (
    <Box>
          ...
          >
            <Grid item width={"100%"}>
              ...
              <Typography variant="h6" gutterBottom>
                What is a Mesomorphic ectomorph?
              </Typography>
      ...
      <TypeExample carouselImages={MEcImages} />
      <CounterShare />
      {/* <CommentPage /> */}
    </Box>
  );
